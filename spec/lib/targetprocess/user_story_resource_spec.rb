...
describe Targetprocess::UserStoryResource do
	...
	describe "#story_by_ids", :vcr => true do
		it "should be an instance of Userstory" do
 				response = storyResource.story_by_ids(182)
				story = Targetprocess::Userstory.new(:id=>182, :name=>"Edit Area", :description=>nil, :createdate=>"2013-06-18T09:20:00", :modifydate=>"2013-06-28T09:40:00", :startdate=>nil, :enddate=>nil, :lastcommentdate=>nil, :tags=>nil, :numericpriority=>59.5, :effort=>8.0, :effortcompleted=>0.0, :efforttodo=>8.0, :timespent=>0.0, :timeremain=>8.0, :initialestimate=>8.0, :entitytype_id=>4, :entitytype_name=>"UserStory", :owner_id=>7, :owner_firstname=>"Jack", :owner_lastname=>"Blue", :lastcommenteduser=>nil, :project_id=>2, :project_name=>"Tau Product - Kanban #1", :release_id=>6, :release_name=>"Release #2", :iteration=>nil, :teamiteration=>nil, :team=>nil, :priority_id=>2, :priority_name=>"Great", :entitystate_id=>40, :entitystate_name=>"Planned", :feature=>nil, :customfields=>nil)
