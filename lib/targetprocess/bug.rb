module Targetprocess  
  class Bug
    ...
    INT_VAR = %w( id userstory_id entitystate_id priority_id team_id teamiteration_id iteration_id release_id project_id lastcommenteduser_id owner_id entitytype_id numericpriority build_id severity_id )
    ...
    ALL_VAR = [:id, :name , :description, :startdate, :enddate, :createdate, :modifydate, :lastcommentdate, :tags, :numericpriority, :effort, :effortcompleted, :efforttodo, :timespent, :timeremain, :entitytype, 
               ...
               :priority_id, :priority_name, :entitystate, :entitystate_id, :entitystate_name, :userstory, :userstory_id, :userstory_name, :customfields, :severity, :severity_id, :severity_name, :build, :build_id,
               :build_name]
